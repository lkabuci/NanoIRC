...
//     _fillSuccessMap();
// std::map<ERROR_CODES::CODES, std::string> Reply::_errorReply =
// _fillErrorMap();
...
//    ret[ERROR_CODES::ERR_NORECIPIENT] = ":No recipient given
//    (PRIVMSG/NOTICE)"; ret[ERROR_CODES::ERR_NOTEXTTOSEND] = ":No text to
//    send"; ret[ERROR_CODES::ERR_TOOMANYTARGETS] =
